...
class TransactionServiceTest {
    ...
    @Test
        ...
        TransactionDto transactionDto =
                transactionService.useBalance(1L, "100000000",
                200L);
        //then
        verify(transactionRepository, times(1)).save(captor.capture());
        assertEquals(200, captor.getValue().getAmount());
    ...
    @Test
    @DisplayName("계좌의 소유주가 다를 때 - 잔액 사용 실패")
    void useBalanceFailed_userUnMatch() {
        //given
        AccountUser pobi = AccountUser.builder()
                .id(12L)
                .name("Pobi").build();
        AccountUser eddie = AccountUser.builder()
                .id(13L)
                .name("Eddie").build();
    ...
    void successCancelBalance() {
        ...
        //when
        TransactionDto transactionDto =
                transactionService.cancelBalance("transactionId", "100000000",
                        CANCEL_AMOUNT);
        //then
        verify(transactionRepository, times(1)).save(captor.capture());
    ...
    void cancelTransaction_TransactionAccountUnMatch() {
        ...
        given(transactionRepository.findByTransactionId(anyString()))
                .willReturn(Optional.of(transaction));
        //근데 transaction이 갖고 있지 않은 계좌를 고름
        given(accountRepository.findByAccountNumber(anyString()))
    ...
    @Test
    @DisplayName("거래 가능 시점이 지남 - 잔액 사용 취소 실패")
